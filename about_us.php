...
<body style="background-color:white;">
    ...
    <center>
        <div class="container" style="margin-top: 9%; padding:10px 80px 10px 80px; ">
            <div
                style="width:80%; background:#212529; padding:5px 5px 5px 5px; border-radius:30px; box-shadow: 2px 2px 10px gray;">
                <h1 style=" color:white;">About</h1>
            </div>
            <br><br>
            <img src="images/PROFILE.jpeg" alt="" style="width:20%; box-shadow:2px 2px 15px black;">
            <br><br>
            <p style="color:white;">Created by</p>
            <h1 style="color:#212529; text-shadow:2px 2px 2px gray;">ESHWARI TAYADE</h1>
